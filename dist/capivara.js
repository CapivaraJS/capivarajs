...
var CPClass = /** @class */ (function () {
    ...
    CPClass.prototype.init = function () {
        var _this = this;
        try {
            console.log(_common__WEBPACK_IMPORTED_MODULE_0__["Common"].evalInMultiContext(this.element, this.attribute));
