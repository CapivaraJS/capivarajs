...
describe('This will test create element function', () => {
  ...
  it('Should create the element', () => {
    expect(element['$$cpDestroyed']).toEqual(false);
  });
});
...
// describe('This will test create element function', () => {
//   capivara.component('teste', { template: '<h1>ola</h1>' });

//   const element = document.createElement('teste');
//   document.body.appendChild(element);
//   capivara.createComponents();
//   const component = document.querySelector('teste');
//   capivara.destroyIfComponent(component);
//   it('Should is be destroyed', () => {
//     expect(component['$instance'].destroyed).toEqual(true);
//   });
// });
